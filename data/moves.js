...
exports.BattleMovedex = {
	...
	"acid": {
		...
		basePower: 80,
		category: "Special",
		desc: "Has a 70% chance to lower the target's Defense and Special Defense by 1 stage.",
		shortDesc: "70% chance to lower the foe(s) Def and Sp. Def by 1.",
		id: "acid",
		name: "Acid",
		pp: 10,
		priority: 0,
	...
	"acidspray": {
		...
		basePower: 90,
		category: "Special",
		desc: "Has a 30% chance to lower the target's Special Defense by 4 stages.",
		shortDesc: "30% chance to lower the target's Sp. Def by 4.",
		id: "acidspray",
		isViable: true,
		name: "Acid Spray",
		pp: 10,
	...
	"airslash": {
		...
		basePower: 70,
		category: "Special",
		desc: "Has a 25% chance to flinch the target.",
	...
	"ancientpower": {
		...
		basePower: 80,
		category: "Physical",
		desc: "Has a 35% chance to raise the user's Attack by 1 stage.",
		shortDesc: "35% chance to raise atk 1.",
		id: "ancientpower",
		isViable: true,
		name: "Ancient Power",
		pp: 10,
	...
	"aquaring": {
		...
		basePower: 0,
		category: "Status",
		desc: "The user has 1/8 of its maximum HP, rounded down, restored at the end of each turn while it remains active. If the user uses Baton Pass, the replacement will receive the healing effect.",
	...
	"aquatail": {
		...
		basePower: 105,
		category: "Physical",
		desc: "User violently attacks with its tail. Usually goes first",
		shortDesc: "Has increased priority",
		id: "aquatail",
		isViable: true,
		name: "Aqua Tail",
		pp: 10,
	...
	"armthrust": {
		...
		basePower: 27,
		category: "Physical",
		desc: "Hits three to five times. Has a 1/3 chance to hit two or three times, and a 1/6 chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Ability Skill Link, this move will always hit five times.",
	...
	"aurorabeam": {
		...
		basePower: 80,
		category: "Special",
		desc: "Has a 40% chance to lower the target's Defense and Special Defense by 1 stage.",
		shortDesc: "40% chance to lower the foe's Defensive Stats by 1.",
		id: "aurorabeam",
		name: "Aurora Beam",
		pp: 20,
		priority: 0,
	...
	"avalanche": {
		...
		basePower: 105,
		category: "Physical",
		desc: "25% chance to flinch target.",
		shortDesc: "25% chance to flinch target.",
		id: "avalanche",
		isViable: true,
		name: "Avalanche",
		pp: 10,
	...
	"babydolleyes": {
		...
		basePower: 0,
		category: "Status",
		desc: "Lowers the target's Offensive and Defensive stats but increases their speed",
		shortDesc: "Lowers the target's Offensive/Defensive stats but increases speed",
		id: "babydolleyes",
		name: "Baby-Doll Eyes",
		pp: 30,
		priority: 1,
	...
	"blizzard": {
		...
		basePower: 110,
		category: "Special",
		desc: "Has a 20% chance to freeze the target. If the weather is Hail, this move does not check accuracy.",
	...
	"boneclub": {
		...
		basePower: 90,
		category: "Physical",
		desc: "Has a 40% chance to flinch the target.",
	...
	"bonemerang": {
		...
		basePower: 50,
		category: "Physical",
		desc: "Hits twice. If the first hit breaks the target's substitute, it will take damage for the second hit. Bypasses Protect.",
		shortDesc: "Hits 2 times in one turn. Bypasses Protect.",
		id: "bonemerang",
		isViable: true,
		name: "Bonemerang",
		pp: 10,
	...
	"hyperdrill": {
		...
		basePower: 140,
		category: "Physical",
		desc: "40% Chance to increase attack by 1 stage.",
		shortDesc: "40% Chance to increase attack by 1 stage",
		id: "hyperdrill",
		isViable: true,
		name: "Hyper Drill",
		pp: 10,
	...
	"brickbreak": {
		...
		basePower: 95,
		category: "Physical",
		desc: "If this attack does not miss, the effects of Reflect and Light Screen end for the target's side of the field before damage is calculated. Bypasses Protect.",
		shortDesc: "Destroys screens, unless the target is immune. Bypasses Protect.",
		id: "brickbreak",
		isViable: true,
		name: "Brick Break",
		pp: 15,
		priority: 0,
		flags: {contact: 1, protect: 0, mirror: 1},
		onTryHit: function (pokemon) {
	...
	"bulldoze": {
		...
		basePower: 80,
		category: "Physical",
		desc: "Has a 100% chance to lower the target's Speed by 1 stage. Has increased priority",
		shortDesc: "100% chance to lower adjacent Pkmn Speed by 1. +1 priority",
		id: "bulldoze",
		name: "Bulldoze",
		pp: 20,
		priority: 0,
	...
	"bulletpunch": {
		...
		category: "Physical",
		desc: "Bypasses Protect.",
		shortDesc: "Usually goes first. Bypasses Protect.",
		id: "bulletpunch",
		isViable: true,
		name: "Bullet Punch",
		pp: 30,
	...
	"charge": {
		...
		basePower: 0,
		category: "Status",
		desc: "Raises the user's Offensive Stats by 1 stage. If the user uses an Electric-type attack on the next turn, its power will be doubled.",
		shortDesc: "Boosts next Electric move and user's Offensive Stats by 1.",
		id: "charge",
		name: "Charge",
		pp: 20,
		priority: 0,
	...
	"confusion": {
		...
		basePower: 80,
		category: "Special",
		desc: "Has a 70% chance to confuse the target.",
		shortDesc: "70% chance to confuse the target.",
		id: "confusion",
		name: "Confusion",
		pp: 25,
		priority: 0,
	...
	"dazzlinggleam": {
		...
		basePower: 80,
		category: "Special",
		desc: "May confuse targets.",
		shortDesc: "May confuse targets. Hits adjacent foes.",
		id: "dazzlinggleam",
		isViable: true,
		name: "Dazzling Gleam",
		pp: 10,
	...
	"dracometeor": {
		...
		basePower: 130,
		category: "Special",
		desc: "Lowers the user's Special Attack and Special Defense by 2 stages.",
		shortDesc: "Lowers the user's Special Attack and Special Defense by 2.",
		id: "dracometeor",
		isViable: true,
		name: "Draco Meteor",
		pp: 5,
	...
	"dragonascent": {
		...
		shortDesc: "Mega Evolves Rayquaza",
		id: "dragonascent",
		isViable: true,
		name: "Dragon Ascent",
		pp: 5,
	...
	"dragonrage": {
		...
		damage: 120,
		category: "Special",
		desc: "Deals 120 HP of damage to the target.",
		shortDesc: "Always does 120 HP of damage.",
		id: "dragonrage",
		name: "Dragon Rage",
		pp: 10,
		priority: 2,
	...
	"dragonrush": {
		...
		basePower: 108,
		category: "Physical",
		desc: "Has a 10% chance to flinch the target. Damage doubles and no accuracy check is done if the target has used Minimize while active.",
	...
	"drainpunch": {
		...
		basePower: 90,
		category: "Physical",
		desc: "The user recovers 75% of the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3x normal, rounded half down.",
		shortDesc: "User recovers 75% of the damage dealt.",
		id: "drainpunch",
		isViable: true,
		name: "Drain Punch",
	...
	"daysfeast": {
		...
		basePower: 85,
		category: "Physical",
		desc: "The user bites into their opponent and heals 100% damage inflicted. 30% Chance Defense Increase",
		shortDesc: "User recovers 100% of the damage dealt. 30% Chance Defense Increase",
		id: "daysfeast",
		isViable: true,
		name: "Days' Feast",
		pp: 10,
	...
	"earthpower": {
		...
		basePower: 90,
		category: "Special",
		desc: "Has a 40% chance to lower all of the target's stats by 1 stage.",
		shortDesc: "40% chance to lower all of the target's stats by 1.",
		id: "earthpower",
		isViable: true,
		name: "Earth Power",
		pp: 10,
	...
	"explosion": {
		...
		basePower: 230,
		category: "Physical",
		desc: "The user faints after using this move, even if this move fails for having no target. This move is prevented from executing if any active Pokemon has the Ability Damp. Bypasses Protect.",
		shortDesc: "Hits adjacent Pokemon. The user faints. Bypasses Protect.",
		id: "explosion",
		isViable: true,
		name: "Explosion",
		pp: 5,
	...
	"fakeout": {
		...
		basePower: 80,
		category: "Physical",
		desc: "Has a 70% chance to flinch the target. Fails unless it is the user's first turn on the field.",
		shortDesc: "Usually hits first. First turn out only. 70% flinch chance.",
		id: "fakeout",
		isViable: true,
		name: "Fake Out",
		pp: 10,
		...
		onHit: function (target, source) {
			...
			for (let i = 0; i < allyActive.length; i++) {
				if (allyActive[i] && this.isAdjacent(target, allyActive[i])) {
					this.damage(allyActive[i].maxhp / 5, allyActive[i], source, 'flameburst');
				}
			}
		},
		secondary: false,
	...
	"flowershield": {
		...
		basePower: 0,
		category: "Status",
		desc: "Raises the Defense of all Grass-type Pokemon on the field by 2 stages.",
		...
		onHitField: function (target, source) {
			...
			for (let i = 0; i < targets.length; i++) {
				this.boost({def: 2}, targets[i], source, this.getMove('Flower Shield'));
			}
		},
		secondary: false,
		target: "all",
	...
	"geomancy": {
		...
		noPPBoosts: true,
		priority: 2,
		flags: {pulse: 1, distance: 1, heal: 1},
		onHit: function (target, source) {
	...
	"glaciate": {
		...
		onBasePower: function (power, user) {
			if (user.template.id === 'kyuremwhite') return this.chainModify(1.5);
		},
		onBasePower: function (power, user) {
			if (user.template.id === 'kyuremblack') return this.chainModify(1.5);
		},
		category: "Special",
		desc: "Has a 100% chance to lower the target's Speed and Defense by 1 stage.",
		shortDesc: "100% chance to lower the foe(s) Speed and Defense by 1.",
		id: "glaciate",
		name: "Glaciate",
		pp: 10,
		priority: 0,
	...
	"guardswap": {
		...
		basePower: 0,
		category: "Status",
		desc: "The user swaps its Defense and Special Defense stats.",
		shortDesc: "Swaps Defense and Sp. Def.",
		id: "guardswap",
		name: "Guard Swap",
		pp: 10,
		priority: 0,
		flags: {},
		volatileStatus: 'guardswap',
		effect: {
			onStart: function (pokemon) {
				this.add('-start', pokemon, 'Guard Swap');
				let newdef = pokemon.stats.spd;
				let newspd = pokemon.stats.def;
			...
			onEnd: function (pokemon) {
				this.add('-end', pokemon, 'Guard Swap');
				let newdef = pokemon.stats.spd;
				let newspd = pokemon.stats.def;
				pokemon.stats.def = newdef;
				pokemon.stats.spd = newspd;
			...
			onRestart: function (pokemon) {
				pokemon.removeVolatile('Guard Swap');
			},
		},
		secondary: false,
		target: "self",
	...
	"gyroball": {
		...
		basePower: 0,
		basePowerCallback: function (pokemon, target) {
			let power = (Math.floor(30 * target.getStat('spe') / pokemon.getStat('spe')) || 1);
	...
	"statfiller": {
		...
		basePower: 0,
		category: "Status",
		desc: "Raises the user's Defense by 2 stages and Special Attack by 1.",
		shortDesc: "Raises the user's Defense by 2 & SpA by 1.",
		id: "statfiller",
		name: "Statfiller",
		pp: 1,
		noPPBoosts: true,
	...
	"healorder": {
		...
		basePower: 0,
		category: "Status",
		desc: "The user modifies the internal structure of its target restoring its HP and badly poising it.",
		shortDesc: "Fully Heals then Toxics the target.",
		id: "healorder",
		isViable: true,
		name: "Heal Order",
		pp: 5,
		...
		onHit: function (target, source) {
			if (source.hasAbility('megalauncher')) {
				this.heal(this.modify(target.maxhp));
			} else {
				this.heal(Math.ceil(target.maxhp));
			}
		},
		secondary: {
			self: {
	...
	"hyperspacefury": {
		...
		basePower: 120,
		category: "Physical",
		desc: "Attacks all targets and forces them to switch out. Breaks protection. User sustains 3/4 damage inflicted",
		shortDesc: "Warps opponents away. Breaks protection. Takes 1/2 damage.",
		id: "hyperspacefury",
		isViable: true,
	...
	"hypervoice": {
		...
		basePower: 105,
		category: "Special",
		desc: "25% chance of lowering SpA by 1 stage.",
		shortDesc: "25% chance of lowering SpA by 1 stage.",
		id: "hypervoice",
		isViable: true,
		name: "Hyper Voice",
		pp: 10,
	...
	"iceball": {
		...
		basePower: 100,
		onBasePower: function (power, user) {
			if (user.item === 'snowball') return this.chainModify(1.5);
		},
		category: "Physical",
	...
	"glacialstrike": {
		...
		basePower: 105,
		category: "Special",
		desc: "Has a 32% chance to freeze the target.",
		shortDesc: "32% chance to freeze the target.",
		id: "glacialstrike",
		isViable: true,
		name: "Glacial Strike",
		pp: 10,
	...
	"landswrath": {
		...
		basePower: 120,
		category: "Physical",
		desc: "Has 18% chance of lowering all of the opponent's stats. Hits adjacent foes.",
		shortDesc: "18% chance to lower all of the opponent's stats. Hits adjacent foes.",
		id: "landswrath",
		name: "Land's Wrath",
		pp: 10,
		priority: 0,
	...
	"leechlife": {
		...
		basePower: 70,
		category: "Physical",
		desc: "The user recovers all of the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3x normal, rounded half down.",
	...
	"leer": {
		...
		shortDesc: "Lowers the foe(s) Defensive Stats by 2.",
		id: "leer",
		name: "Leer",
		pp: 30,
		priority: 0,
	...
	"lightofruin": {
		...
		onTry: function (pokemon) {
			if (pokemon.template.species === 'Mewtwo-Mega-Y') {
				return;
			}
			this.add('-hint', "Only a Pokemon whose form is Mega Mewtwo Y can use this move.");
			if (pokemon.template.species === 'Mewtwo') {
				this.add('-fail', pokemon, 'move: Light of Ruin', '[forme]');
				return null;
			}
			this.add('-fail', pokemon, 'move: Light of Ruin');
			return null;
		},
		onEffectiveness: function (typeMod, type) {
	...
	"megakick": {
		...
		flags: {contact: 1, protect: 1, mirror: 1},
		onModifyMove: function (move, pokemon) {
			move.type = pokemon.types[0]; // Test
		},
		secondary: false,
		target: "normal",
		type: "Normal",
		...
		effect: {
			...
			onDamage: function (damage, target, source, effect) {
				if (effect && effect.effectType === 'Move' && source.side !== target.side) {
					this.effectData.position = source.position;
					this.effectData.damage = 1.1 * damage;
				}
			},
		},
		secondary: false,
	...
	"metalclaw": {
		...
		basePower: 90,
		category: "Physical",
		desc: "Has a 40% chance to raise the user's Attack by 1 stage.",
		shortDesc: "40% chance to raise the user's Attack by 1.",
		id: "metalclaw",
		name: "Metal Claw",
		pp: 35,
		priority: 0,
	...
	"mistball": {
		...
		basePower: 90,
		category: "Special",
		desc: "Has a 50% chance to lower the target's Special Attack and Special Defense by 1 stage each.",
		shortDesc: "50% chance to lower the target's Sp. Atk and Sp. Def by 1.",
		id: "mistball",
		name: "Mist Ball",
		pp: 5,
		priority: 0,
	...
	"mudshot": {
		...
		category: "Special",
		desc: "Has a 100% chance to lower the target's Speed by 1 stage, has increased priority.",
		shortDesc: "100% chance to lower the target's Speed by 1, has increased priority.",
		id: "mudshot",
		name: "Mud Shot",
		pp: 15,
		priority: 2,
	...
	"nightdaze": {
		...
		basePower: 110,
		category: "Special",
		desc: "Has a 40% chance to lower the target's Special Defense by 1 stage. Never misses.",
		shortDesc: "40% chance to lower the target's Special Defense by 1 stage. Never misses.",
		id: "nightdaze",
		name: "Night Daze",
		pp: 10,
		priority: 0,
	...
	"essencecrusher": {
		...
		basePower: 130,
		category: "Physical",
		desc: "The user recovers 3/5 the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3x normal, rounded half down.",
		shortDesc: "User recovers 40% of the damage dealt.",
		id: "essencecrusher",
		isViable: true,
		name: "Essence Crusher",
		pp: 10,
    noPPBoosts: true,
		priority: 0,
		flags: {protect: 1, mirror: 1, distance: 1, heal: 1},
	...
	"ominouswind": {
		...
		basePower: 90,
		category: "Special",
		desc: "Has a 30% chance to raise the user's Special Attack by 1 stage.",
		shortDesc: "30% chance to raise SpA by 1.",
		id: "ominouswind",
		name: "Ominous Wind",
		pp: 10,
		priority: 0,
	...
	"poisonjab": {
		...
		basePower: 90,
		category: "Physical",
		desc: "Has a 70% chance to poison the target.",
		shortDesc: "70% chance to poison the target.",
		id: "poisonjab",
		isViable: true,
		name: "Poison Jab",
		pp: 20,
	...
	"powerswap": {
		...
		basePower: 0,
		category: "Status",
		desc: "The user swaps its Attack and Special Attack stats.",
		shortDesc: "Swaps Attack and Sp. Atk stats.",
		id: "powerswap",
		name: "Power Swap",
		pp: 10,
		priority: 0,
		flags: {},
		volatileStatus: 'powerswap',
		effect: {
			onStart: function (pokemon) {
				this.add('-start', pokemon, 'Power Swap');
				let newatk = pokemon.stats.spa;
				let newspa = pokemon.stats.atk;
			...
			onEnd: function (pokemon) {
				this.add('-end', pokemon, 'Power Swap');
				let newatk = pokemon.stats.spa;
				let newspa = pokemon.stats.atk;
				pokemon.stats.atk = newatk;
				pokemon.stats.spa = newspa;
			...
			onRestart: function (pokemon) {
				pokemon.removeVolatile('Power Swap');
			},
		},
		secondary: false,
		target: "self",
	...
	"precipiceblades": {
		...
		category: "Physical",
		desc: "Bypasses Protect.",
		shortDesc: "Bypasses Protect. Hits adjacent Pokemon.",
		id: "precipiceblades",
		isViable: true,
	...
	"psychoboost": {
		...
		basePower: 90,
		category: "Special",
		desc: "Raises the user's Special Attack by 1 stages.",
	...
	"psyshock": {
		...
		basePower: 100,
		category: "Special",
		desc: "Deals damage to the target based on its Special Defense.",
		shortDesc: "Damages target based on Sp. Def.",
		id: "psyshock",
		isViable: true,
		name: "Psyshock",
		pp: 10,
	...
	"psystrike": {
		...
		desc: "If Special Attack is higher, attack becomes special and targets defense, if Attack is higher, becomes physical and targets special defense",
		shortDesc: "Inverse offensive properties depending on highest stat",
		id: "psystrike",
		isViable: true,
		name: "Psystrike",
		pp: 10,
	...
	"relicsong": {
		...
		onHit: function (target, pokemon) {
			if (pokemon.baseTemplate.species === 'Meloetta' && !pokemon.transformed || pokemon.baseTemplate.species === 'Meloetta-Pirouette' && !pokemon.transformed) {
	...
	"rocksmash": {
		...
		basePower: 95,
		category: "Physical",
		desc: "Has a 50% chance to lower the target's Defense by 1 stage, bypasses Protect.",
		shortDesc: "50% chance to lower the target's Defense by 1 stage, bypasses Protect.",
		id: "rocksmash",
		name: "Rock Smash",
		pp: 15,
    breaksProtect: true,
	...
	"royalpunishment": {
		...
		basePower: 45,
		onBasePower: function (power, user) {
			if (user.template.id === 'missingno') return this.chainModify(1.5);
		},
		onBasePower: function (power, user) {
			if (user.template.id === 'porygon') return this.chainModify(1.5);
		},
		onBasePower: function (power, user) {
			if (user.template.id === 'porygon2') return this.chainModify(1.5);
		},
		onBasePower: function (power, user) {
			if (user.template.id === 'porygonz') return this.chainModify(1.5);
		},
		onBasePower: function (power, user) {
			if (user.template.id === 'slowking') return this.chainModify(1.5);
		},
		category: "Physical",
		desc: ".",
		shortDesc: ".",
		...
		recoil: [30, 100],
		onEffectiveness: function (typeMod, type) {
			if (type === 'Bug' || type === 'Dark' || type === 'Dragon' || type === 'Electric' || type === 'Fairy' || type === 'Fighting' || type === 'Fire' || type === 'Flying' || type === 'Ghost' || type === 'Grass' || type === 'Ground' || type === 'Ice' || type === 'Normal' || type === 'Poison' || type === 'Psychic' || type === 'Rock' || type === 'Steel' || type === 'Water') return 1;
		},
		target: "any",
		type: "???",
	},
	...
	"scratch": {
		...
		basePower: 80,
		category: "Physical",
		desc: "Has high Critical Hit Ratio.",
		shortDesc: "High Critical Hit Ratio.",
		id: "scratch",
		name: "Scratch",
		pp: 35,
	...
	"shellsmash": {
		...
		basePower: 80,
		category: "Physical",
		desc: "Lowers the user's Defense and Special Defense by 1 stage. Raises the user's Attack, Special Attack, and Speed by 1 stage.",
	...
	"silverwind": {
		...
		shortDesc: "10% chance to raise all stats by 2 (not acc/eva).",
		id: "silverwind",
		name: "Silver Wind",
		pp: 5,
		priority: 0,
	...
	"mysteryslash": {
		...
		category: "Physical",
		desc: "25% chance to poison",
		shortDesc: "25% chance to poison.",
		id: "mysteryslash",
		name: "Mystery Slash",
		pp: 20,
		priority: 0,
	...
	"mysterysphere": {
		...
		basePower: 140,
		onBasePower: function (power, user) {
			if (user.template.id === 'missingno') return this.chainModify(1.4);
		},
		onBasePower: function (power, user) {
			if (user.template.id === 'porygon') return this.chainModify(1.5);
		},
	...
	"mysterywave": {
		...
		basePower: 1,
		category: "Special",
		desc: "Has a 100% chance to either freeze, poison, or paralyze the target .",
		shortDesc: "100% chance to freeze or poison or paralyze target.",
		id: "mysterywave",
		isViable: true,
		name: "Mystery Wave",
		pp: 28,
	...
	"mysterybind": {
		...
		category: "Physical",
		desc: "Traps and damages opponents",
		shortDesc: "Traps and damages opponents",
		id: "mysterybind",
		name: "Mystery Bind",
		pp: 4,
		noPPBoosts: true,
		...
		volatileStatus: 'partiallytrapped',
		onEffectiveness: function (typeMod, type) {
			if (type === 'Flying' || type === 'Dragon' || type === 'Ghost' || type === 'Fairy') return 1;
		},
		secondary: {
			chance: 100,
			volatileStatus: 'curse',
	...
	"auradrain": {
		...
		basePower: 100,
		category: "Special",
		desc: "The user recovers 90% of the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3x normal, rounded half down.",
		shortDesc: "User recovers 90% of the damage dealt.",
		id: "auradrain",
		isViable: true,
		name: "Aura Drain",
		pp: 5,
	...
	"sonicboom": {
		...
		basePower: 120,
		category: "Special",
		desc: "Deals 150 HP of damage to the target.",
		shortDesc: "Always does 150 HP of damage.",
		id: "sonicboom",
		name: "Sonic Boom",
		pp: 20,
		priority: 0,
	...
	"spacialrend": {
		...
		basePower: 100,
		category: "Special",
		desc: "Restores Health on contact",
		shortDesc: "Restores Health on contact",
		id: "spacialrend",
		isViable: true,
		name: "Spacial Rend",
		pp: 5,
	...
	"splash": {
		...
		basePower: 0,
		category: "Physical",
		desc: "Splash has returned and is now viable!",
		shortDesc: "Splash has returned and is now viable!",
		id: "splash",
		name: "Splash",
		pp: 40,
		priority: -1,
	...
	"steelwing": {
		...
		basePower: 95,
		category: "Physical",
		desc: "Has a 45% chance to raise the user's Defense by 1 stage.",
		shortDesc: "45% chance to raise the user's Defense by 1.",
		id: "steelwing",
		name: "Steel Wing",
		pp: 25,
		priority: 0,
	...
	"storedpower": {
		...
		category: "Special",
		desc: "Power gets doubled if user is holding an item at the cost of recoil",
		shortDesc: "Power gets doubled if user is holding an item. Has recoil damage",
		id: "storedpower",
		name: "Stored Power",
		pp: 10,
		priority: 0,
	...
	"strengthsap": {
		...
		basePower: 0,
		basePowerCallback: function (pokemon, target) {
			let power = (Math.floor(45 * target.getStat('spa') / pokemon.getStat('spa')) || 1);
			if (power > 150) power = 150;
			this.debug('' + power + ' bp');
			return power;
		},
		category: "Physical",
		desc: "Power is equal to (45 * target's current SpA / user's current SpA), rounded down, + 1, but not more than 150.",
		shortDesc: ".",
		id: "strengthsap",
		isViable: true,
		name: "Strength Sap",
	...
	"fleurcannon": {
		...
		priority: 0,
		flags: {protect: 1, mirror: 1},
		onHit: function (attacker, source, move) {
			if (this.random(8) === 0) {
				source.trySetStatus('brn', attacker);
			}
		},
		secondary: false,
		target: "normal",
	...
	"submission": {
		...
		flags: {contact: 1, protect: 1, mirror: 1, authentic: 1},
		onTry: function (pokemon) {
			if (pokemon.template.species === 'Mewtwo-Mega-X') {
				return;
			}
			this.add('-hint', "Only a Pokemon whose form is Mega Mewtwo X can use this move.");
			if (pokemon.template.species === 'Mewtwo') {
				this.add('-fail', pokemon, 'move: Submission', '[forme]');
				return null;
			}
			this.add('-fail', pokemon, 'move: Submission');
			return null;
		},
		onEffectiveness: function (typeMod, type) {
			if (type === 'Ice') return 1;
	...
	"substitute": {
		...
		onTryHit: function (target) {
			...
			if (target.hp <= target.maxhp / 3 || target.maxhp === 1) { // Shedinja clause
		...
		effect: {
			onStart: function (target) {
				...
				this.effectData.hp = Math.floor(target.maxhp / 1.3);
	...
	"teleport": {
		...
		basePower: 85,
		category: "Special",
		desc: "Teleports opponents away.",
		shortDesc: "Teleports opponents away.",
		id: "teleport",
		name: "Teleport",
		pp: 6,
		noPPBoosts: true,
	...
	"thousandarrows": {
		...
		basePower: 50,
		onBasePower: function (power, user) {
			if (user.template.id === 'zygarde') return this.chainModify(1.5);
		},
		onBasePower: function (power, user) {
			if (user.template.id === 'zygarde10') return this.chainModify(1.5);
		},
		onBasePower: function (power, user) {
			if (user.template.id === 'zygardecomplete') return this.chainModify(1.5);
		},
		category: "Physical",
		...
		flags: {protect: 1, mirror: 1, nonsky: 1},
		onEffectiveness: function (typeMod, type) {
			if (type === 'Flying' || type === 'Rock' || type === 'Electric' || type === 'Fire' || type == 'Ice') return 1;
		},
		multihit: [2, 3],
		critRatio: 2,
		onEffectiveness: function (typeMod, type, move) {
	...
	"thundershock": {
		...
		basePower: 50,
		category: "Special",
		desc: "Has a 40% chance to paralyze the target.",
	...
	"triattack": {
		...
		category: "Special",
		desc: "Has a 40% chance to either burn, freeze, or paralyze the target.",
		shortDesc: "40% chance to paralyze or burn or freeze target.",
		id: "triattack",
		isViable: true,
		name: "Tri Attack",
		pp: 25,
	...
	"vcreate": {
		...
		damage: 280,
		category: "Physical",
		desc: " User sustains massive damage to increase all the stats by 1 stage",
		shortDesc: "User risks life to increase all stats",
		id: "vcreate",
		isViable: true,
		name: "V-create",
		pp: 2,
		...
		effect: {
			onStart: function (pokemon) {
				this.add('-start', pokemon, 'move: V-Create');
			},
			onModifyMove: function (move) {
				move.willCrit = true;
			},
