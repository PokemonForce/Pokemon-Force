...
exports.Formats = [
...

	{
		...
		onValidateSet: function (set) {
			...
			if (template.tier === 'Uber' || template.species in {'Cresselia':0, 'Dragonite':1, 'Kyurem-Black':1, 'Lucario':0, 'Slaking':1, 'Smeargle':1, 'Regigigas':1}) {
			...
			switch (item.id) {
			case 'beedrillite': case 'kangaskhanite': case 'mewtwonitex':
